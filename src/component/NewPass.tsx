                ...
                <Col span={10} className="login-local">
                    ...
                    <Row style={{ width: "100%" }}>
                        ...
                        >
                            ...
                            <h2 className="text1" style={{ fontWeight: '400', marginLeft: '-370px' }}>Mật khẩu *</h2>
                            <Form.Item
                                // label="Mật khẩu *"
                                name="password"
                            ...
                            <h2 className="text1" style={{ fontWeight: '400', marginLeft: '-300px' }}>Nhập lại mật khẩu *</h2>
                            <Form.Item
                            ...
                            <Form.Item wrapperCol={{ offset: 8, span: 16 }}>
                                <Link to='/login'>
                                    <Button type="primary" htmlType="submit" className="button-confirm" style={{ marginLeft: '-180px', borderRadius: "0.8rem", paddingTop: "0.2rem", width: "10rem", height: "3rem" }}>
                                        Xác nhận
                                    </Button>
                                </Link>
                            </Form.Item>
